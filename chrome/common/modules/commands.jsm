...
var Commands = Module("commands", {
    ...
    nameRegexp: util.regexp(/* Preprocessors FTW. */ '\n\
            [^\n\
                0-9\n\
                <forbid>\n\
            ]\n\
            [^ <forbid> ]*\n\
        ', "gx", {
        forbid: util.regexp(String.replace(/* Preprocessors FTW. */ '\n\
            U0000-U002c // U002d -\n\
            U002e-U002f\n\
    ...
    commandRegexp: Class.Memoize(function commandRegexp() util.regexp(/* Preprocessors FTW. */ '\n\
            ^\n\
            (?P<spec>\n\
                (?P<prespace> [:\\s]*)\n\
                (?P<count>    (?:\\d+ | %)? )\n\
