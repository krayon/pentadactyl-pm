...
/* Preprocessors FTW. */ '" Vim filetype detection file\n\
<header>\n\
\n\
au BufNewFile,BufRead *<name>rc*,*.<fileext> set filetype=<name>\n\
';//}}}
                rtItems.ftplugin.template = //{{{
/* Preprocessors FTW. */ '" Vim filetype plugin file\n\
<header>\n\
\n\
...
/* Preprocessors FTW. */ '" Vim syntax file\n\
<header>\n\
\n\
...
';//}}}
    ...
    completion: function initCompletion(dactyl, modules, window) {
        ...
        completion.addUrlCompleter("file", "Local files", function (context, full) {
            let match = util.regexp(/* Preprocessors FTW. */ '\n\
                ^\n\
                (?P<prefix>\n\
                    (?P<proto>\n\
